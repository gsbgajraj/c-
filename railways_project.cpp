...
textcolor(CYAN);
cout<<"\t\t\t\t";
cprintf("INDIAN RAILWAYS");
cout<<"\n";
textcolor(RED);
cout<<"\t\t\t";
cprintf("  AIM TO SERVE OUR TRAVELLERS");
cout<<"\n";
textcolor(BROWN);
delay(1000);
cprintf("Prepared by:");
...
cout<<"\n";
delay(1000);
cprintf("1. Gajraj Singh Bhati");
cout<<"\n";
delay(1000);
cprintf("2. Ashutosh Jain");
cout<<"\n";
delay(1000);
cprintf("3. Devdeep Singh Rathore");
cout<<"\n";
delay(1000);
cprintf("4. DevanshAheer");
cout<<"\n\n\n";
textcolor(GREEN);
cprintf("Enter the password please:");
gets(Password);
textcolor(CYAN);
